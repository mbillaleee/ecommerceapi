        ...
        <div class="container">
            <div class="row">
                ...
                <article class="gallery-wrap"> 
                    ...
                    <a data-fslightbox="mygalley" data-type="image" href="./images/big.webp"> 
                        <img height="560" src="./images/big.webp" alt="image" /> 
                    </a>
                    </div> 
                    <div class="thumbs-wrap">
                    <a data-fslightbox="mygalley" data-type="image" href="./images/thumb1.webp" class="item-thumb"> 
                        <img width="60" height="60" src="/images/thumb1.webp" alt="product" /> 
                    </a>
                    <a data-fslightbox="mygalley" data-type="image" href="./images/thumb2.webp" class="item-thumb"> 
                        <img width="60" height="60" src="./images/thumb2.webp" alt="product" />  
                    </a>
                    <a data-fslightbox="mygalley" data-type="image" href="./images/thumb3.webp" class="item-thumb"> 
                        <img width="60" height="60" src="./images/thumb3.webp" alt="product" />  
                    </a>
                    <a data-fslightbox="mygalley" data-type="image" href="./images/thumb4.webp" class="item-thumb"> 
                        <img width="60" height="60" src="./images/thumb4.webp" alt="product" />  
                    </a>
                    <a data-fslightbox="mygalley" data-type="image" href="./images/thumb.webp" class="item-thumb"> 
                        <img width="60" height="60" src="./images/thumb.webp" alt="product" />  
                    </a>
                    </div> 
                </article> 
                </aside>
                ...
                <article class="ps-lg-3">
                    ...
                    <ul class="rating-stars">
                        <li class="stars-active"> <img src="./images/stars-active.svg"  alt="product" /> </li>
                        {/* style="width:80%"  */}
            ...
            <div class="row">
                ...
                <aside class="col-lg-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="aside">
                            <img src="images/8.webp" width="96" height="96" class="img-md img-thumbnail"/>
                        </a>
                        <div class="info">
                        ...
                        <article class="itemside mb-3">
                        <a href="" class="aside">
                            <img src="images/9.webp" width="96" height="96" class="img-md img-thumbnail" />
                        </a>
                        <div class="info">
                        ...
                        <article class="itemside mb-3">
                        <a href="" class="aside">
                            <img src="images/10.webp" width="96" height="96" class="img-md img-thumbnail" />
                        </a>
                        <div class="info">
                        ...
                        <article class="itemside mb-3">
                        <a href="" class="aside">
                            <img src="images/11.webp" width="96" height="96" class="img-md img-thumbnail" />
                        </a>
                        <div class="info">
